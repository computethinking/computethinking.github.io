...
In this course, Generative AI considered as an integral tool for learning and building. You are not only permitted but **actively encouraged** to use AI as a collaborative partner. Learning to leverage these tools effectively and ethically is a core learning objective.
